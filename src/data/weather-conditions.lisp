...
(defparameter *weather-condition-catalog*
  '(
   ...
   (:id 701 :group "Mist" :description "mist" :icon "50d")
   (:id 711 :group "Smoke" :description "smoke" :icon "50d")
   (:id 721 :group "Haze" :description "haze" :icon "50d")
   (:id 731 :group "Dust" :description "sand/dust whirls" :icon "50d")
   (:id 741 :group "Fog" :description "fog" :icon "50d")
   (:id 751 :group "Sand" :description "sand" :icon "50d")
   (:id 761 :group "Dust" :description "dust" :icon "50d")
   (:id 762 :group "Ash" :description "volcanic ash" :icon "50d")
   (:id 771 :group "Squall" :description "squalls" :icon "50d")
   (:id 781 :group "Tornado" :description "tornado" :icon "50d")
